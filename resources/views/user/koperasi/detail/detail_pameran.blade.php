...
@section('title')
    Detail Pameran {{ ucwords($pameran->title) }}
@endsection
...
@section('content')
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">KEGIATAN PEMELIHARAAN DAN PENGAWASAN
                KOPERASI</h4>
            <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                <li class="breadcrumb-item"><a href="/">Home</a></li>
                <li class="breadcrumb-item text-white">Bidang Koperasi</li>
                <li class="breadcrumb-item"><a href="{{ route('koperasi.pameran') }}">Pameran</a></li>
                <li class="breadcrumb-item active text-white-50">{{ ucwords($pameran->title) }}</li>
            </ol>
        </div>
    </div>
    <!-- Header End -->
                    ...
                    <div class="description-container mx-auto">
                        <div id="pengawasanCarousel" class="carousel slide" data-ride="carousel">
                            <ol class="carousel-indicators">
                                @foreach ($pameran->fotos as $key => $foto)
                        ...
                        <h1 class="display-6 mt-2 text-center">{{ ucwords($pameran->title) }}</h1>
                            ...
                            <div class="latest-item">
                                ...
                                <div>
                                    <a class="h6 d-inline-block"
                                        href="{{ route('show.pameran', $item->id) }}">{{ Str::limit(ucwords($item->title), 50) }}</a>
