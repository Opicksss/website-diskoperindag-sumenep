...
@section('title')
    Detail Penghargaan {{ ucwords($penghargaan->title) }}
@endsection
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            ...
            <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                ...
                <li class="breadcrumb-item"><a href="{{ route('koperasi.penghargaan') }}">Penghargaan</a></li>
                <li class="breadcrumb-item active text-white-50">{{ ucwords($penghargaan->title) }}</li>
            </ol>
        </div>
    </div>
    <!-- Header End -->
                    ...
                    <div class="description-container mx-auto">
                        <div id="pengawasanCarousel" class="carousel slide" data-ride="carousel">
                            <ol class="carousel-indicators">
                                @foreach ($penghargaan->fotos as $key => $foto)
                        ...
                        <h1 class="display-6 mt-2 text-center">{{ ucwords($penghargaan->title) }}</h1>
                            ...
                            <div class="latest-item">
                                ...
                                <div>
                                    <a class="h6 d-inline-block"
                                        href="{{ route('show.penghargaan', $item->id) }}">{{ Str::limit(ucwords($item->title), 50) }}</a>
