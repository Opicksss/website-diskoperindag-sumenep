...
@section('content')
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">KEGIATAN PEMERIKSAAN DAN PENGAWASAN
                KOPERASI</h4>
            <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                <li class="breadcrumb-item"><a href="/">Home</a></li>
                <li class="breadcrumb-item text-white">Bidang Koperasi</li>
                <li class="breadcrumb-item active text-white-50">Pengawasan</li>
            </ol>
        </div>
    </div>
    <!-- Header End -->
            ...
            <div class="row g-4 justify-content-center">
                ...
                @foreach ($pengawasans as $pengawasan)
                    ...
                    @php
                        ...
                        $iteration++;
                        if ($iteration % 4 == 0) {
                            $delay = 0.2; // Reset delay after 4 iterations
                        }
                    @endphp
                @endforeach
            </div>
