...
@section('content')
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">KOPERASI BERDASARKAN KELOMPOK</h4>
            <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                <li class="breadcrumb-item"><a href="/">Home</a></li>
                <li class="breadcrumb-item text-white">Bidang Koperasi</li>
                <li class="breadcrumb-item active text-white-50">Kelompok</li>
            </ol>
        </div>
    </div>
    <!-- Header End -->
                            ...
                            @foreach ($kelompoks as $kelompok)
                                <tr>
                                    ...
                                    <td style="width: 150px;">
                                        @if ($kelompok->file)
                                            <a class="btn btn-outline-primary d-flex align-items-center" href="{{ asset('kelompok/' . $kelompok->file) }}" target="_blank"><i
                    ...
                    <div class="bg-white shadow rounded p-5 h-100">
                        <div class="row g-4 justify-content-center">
                            ...
                            <div class="col-sm-4">
                                <div class="counter-item bg-light rounded p-3 h-100">
                                    <div class="counter-counting">
                                        <span class="text-primary fs-2 fw-bold" data-toggle="counter-up">{{ $total['data'] }}</span>
                                    </div>
                                    <h4 class="mb-0 text-dark">Jumlah Kelompok</h4>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="counter-item bg-light rounded p-3 h-100">
                                    <div class="counter-counting">
                                        <span class="text-primary fs-2 fw-bold" data-toggle="counter-up">{{ $total['jumlah'] }}</span>
                                    </div>
                            ...
                            <div class="col-sm-4">
                                <div class="counter-item bg-light rounded p-3 h-100">
                                    <div class="counter-counting">
                                        <span class="text-primary fs-2 fw-bold" data-toggle="counter-up">{{ $total['aktif'] }}</span>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="counter-item bg-light rounded p-3 h-100">
                                    <div class="counter-counting">
                                        <span class="text-primary fs-2 fw-bold" data-toggle="counter-up">{{ $total['tidak_aktif'] }}</span>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="counter-item bg-light rounded p-3 h-100">
                                    <div class="counter-counting">
                                        <span class="text-primary fs-2 fw-bold" data-toggle="counter-up">{{ $total['anggota'] }}</span>
                                    </div>
