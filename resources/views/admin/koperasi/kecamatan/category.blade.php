...
@section('content')
                            ...
                            <tr>
                                ...
                                <td style="width: 150px;">
                                    <a class="btn btn-outline-primary d-flex align-items-center"
                                        href="{{ route('adminkecamatan.index', $category->id) }}"><i
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <form id="delete-form-{{ $category->id }}"
                                                action="{{ route('categorykecamatan.destroy', $category->id) }}"
                                                method="post">
                                                @csrf
                                                @method('delete')
                            ...
                            <div class="modal fade" id="ModalEdit{{ $category->id }}" data-bs-backdrop="static"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('categorykecamatan.update', $category->id) }}"
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="nama" class="form-label">Kecamatan</small></label>
    ...
    <div class="modal fade" id="ModalCreate" data-bs-backdrop="static" tabindex="-1">
        <div class="modal-dialog">
            <form action="{{ route('categorykecamatan.store') }}" method="post" class="modal-content">
                @csrf
                <div class="modal-header">
            ...
            document.querySelectorAll('.delete-btn').forEach(function(button) {
                button.addEventListener('click', function() {
                    ...
                    Swal.fire({
                        ...
                        text: `Koperasi dari Kecamatan "${bookTitle}" akan dihapus`,
                        icon: 'warning',
